...
<body>
	...
	<form action="listUser.do" method="get" name="inputform">
		<table class="tbl_input" border="0" width="80%" cellpadding="0"
			...
			<tr>
				<td align="center" colspan="2"><font color="red"><c:out value="${errorMessage}"></c:out></font>
				</td>          
			</tr>
			<tr>
				<td align="center" colspan="2">
			...
			<tr>
				<td align="center" colspan="2"><input class="btn" type="button"
					value="OK" onclick="location.href='listUser.do?action=back'" /></td>
			</tr>
		</table>
	</form>
	<!-- End vung input -->
